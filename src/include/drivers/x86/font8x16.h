 ...
 * @brief 8x16 位图字体数据
 * 
 * 标准 VGA 兼容字体，每个字符 8 像素宽，16 像素高
 * 包含 ASCII 字符集（0-255）
 */

#ifndef _DRIVERS_X86_FONT8X16_H_
#define _DRIVERS_X86_FONT8X16_H_
 ...
 * @brief 8x16 位图字体数据
 * 
 * 每个字符占用 16 字节（每行 1 字节，共 16 行）
 * 字节中的每一位代表一个像素，最高位在左侧
 */
static const uint8_t font8x16_data[256 * 16] = {
    ...
    /* 0x80-0xFF: Extended ASCII - simplified fill */
...
#endif /* _DRIVERS_X86_FONT8X16_H_ */
