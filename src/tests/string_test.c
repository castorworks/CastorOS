...
TEST_CASE(test_int32_to_hex_lowercase) {
    ...
    ASSERT_STR_EQ(buffer, "0x12345678");
}
...
TEST_CASE(test_int32_to_hex_zero) {
    ...
    ASSERT_STR_EQ(buffer, "0x00000000");
}
...
TEST_CASE(test_uint32_to_hex_max) {
    ...
    ASSERT_STR_EQ(buffer, "0xffffffff");
...
TEST_CASE(test_int64_to_hex_lowercase) {
    ...
    ASSERT_STR_EQ(buffer, "0xdeadbeefcafebabe");
}
...
TEST_CASE(test_int64_to_hex_zero) {
    ...
    ASSERT_STR_EQ(buffer, "0x0000000000000000");
}
...
TEST_CASE(test_uint64_to_hex_max) {
    ...
    ASSERT_STR_EQ(buffer, "0xffffffffffffffff");
...
TEST_CASE(test_snprintf_hex) {
    ...
    ASSERT_STR_EQ(buffer, "Hex: 0x0000abcd");
...
TEST_CASE(test_snprintf_pointer) {
    ...
    ASSERT_STR_EQ(buffer, "Pointer: 0x12345678");
}
...
TEST_CASE(test_snprintf_mixed) {
    ...
    ASSERT_STR_EQ(buffer, "String: test, Int: 42, Hex: 0x000000ff");
}
