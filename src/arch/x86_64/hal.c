...
/* ============================================================================
 * Cache Maintenance Operations (x86_64)
 * 
 * On x86_64, caches are DMA-coherent (snooped), so explicit cache maintenance
...
/**
 * @brief Clean cache for a memory region (x86_64 - no-op)
 * 
 * On x86_64, caches are DMA-coherent, so this is a no-op.
 * 
...
/**
 * @brief Invalidate cache for a memory region (x86_64 - no-op)
 * 
 * On x86_64, caches are DMA-coherent, so this is a no-op.
 * 
 * @param addr Virtual address of the region start
...
/**
 * @brief Clean and invalidate cache for a memory region (x86_64 - no-op)
 * 
 * On x86_64, caches are DMA-coherent, so this is a no-op.
 * 
 * @param addr Virtual address of the region start
